...
class tl_dlstatdets extends Backend
{
  ...
  public function listRecords($row)
  {
      ...
      . '<span class="dlstats-ip dlstats-left">'.$row['ip'].'<br>'.\String::substr($row['domain'],50).'</span>'
      . '<span class="dlstats-username dlstats-left">'.\String::substr($row['username'],30).'</span>'
      . '</div>';
  } // listRecords
